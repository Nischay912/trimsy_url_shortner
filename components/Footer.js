// use client needed as it has useRef and useEffect use maybe if any ; anyhow it can be viewed on server so let it be client component only thus , here below.
"use client";
...
export default function Footer() {
    ...
    <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Trimsy</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/about" className="text-gray-400 hover:text-white transition-colors">Features</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a target="_blank" href="https://wa.me/7004105775?text=Hello%2C%20I%20want%20to%20know%20more%20about%20your%20URL%20shortener%20service." className="text-gray-400 hover:text-white transition-colors">
  ...
  <path fillRule="evenodd" d="M12.04 2C6.49 2 2 6.48 2 12c0 2.12.55 4.09 1.52 5.8L2 22l4.37-1.44A9.94 9.94 0 0012.04 22C17.58 22 22 17.52 22 12S17.58 2 12.04 2zm0 18c-1.91 0-3.69-.63-5.14-1.69l-.36-.27-2.61.86.88-2.54-.28-.38A7.956 7.956 0 014 12c0-4.42 3.58-8 8.04-8 4.43 0 8.04 3.58 8.04 8s-3.61 8-8.04 8zm4.42-5.83c-.24-.12-1.42-.7-1.64-.78-.22-.08-.38-.12-.54.12s-.62.78-.76.94c-.14.16-.28.18-.52.06-.24-.12-1.02-.38-1.94-1.2-.72-.64-1.2-1.42-1.34-1.66-.14-.24 0-.37.1-.49.1-.12.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.54-1.3-.74-1.78-.2-.48-.4-.42-.54-.42-.14 0-.3-.02-.46-.02s-.42.06-.64.3c-.22.24-.84.82-.84 2 0 1.18.86 2.32.98 2.48.12.16 1.7 2.6 4.12 3.64.58.25 1.03.4 1.38.52.58.2 1.11.17 1.53.1.46-.08 1.42-.58 1.62-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28z" clipRule="evenodd" />
              ...
              <a target="_blank" href="https://x.com/nk_912_kr" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a target="_blank" href="https://www.instagram.com/nk_912kr/" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>{new Date().getFullYear()} &copy; Trimsy • All rights reserved.</p>
        </div>
      </footer>
  );
}
